$(function() {
    $("form[name='application-form']").validate({
      ...
      messages: {
        ...
        "entry.758167786": { required:"Please fill out all fields "},
        'entry.105311915': { required:"Please fill out all fields "},
        "entry.279358715": { required:"Please fill out all fields "},
        "entry.784023676": { required:"Please fill out all fields " },
        "entry.1694289332": { required:"Please fill out all fields " },
